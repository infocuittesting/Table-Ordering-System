...
def dbfetch(sql):
     print(sql)
     try:
      con = psycopg2.connect(user='uyaavkajbehotx',password='6667bd26a9210872d165548a4c5f84b9dbcd642b4d8881f04a506b636d892956',host='ec2-79-125-4-72.eu-west-1.compute.amazonaws.com',port='5432',database='dd2erm98cl357t')
      cur = con.cursor()
